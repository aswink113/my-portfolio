...
if os.path.exists("profile.jpg"):
    ...
    bg_style = f"""
        background: linear-gradient(to right, rgba(10,20,40,0.95), rgba(10,20,40,0.6)),
...
# --- 5. STATS ---
components.html("""<h3 style="text-align:center;color:#aaa">Animated Stats Loaded</h3>""", height=120)
...
<div class="about-box">
    <p style="font-size:1.15rem; line-height:1.8;">
        Data Scientist & AI Python Trainer with Diploma in Electronics.
        Specialized in ML, CV & Generative AI.
    </p>
</div>
""", unsafe_allow_html=True)
